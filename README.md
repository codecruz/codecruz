...
<table>
  <tr>
    <td align="center" width="50%" valign="top">
      <h3>🏋️ AniFit</h3>
      <a href="https://anifit-livid.vercel.app/">
        <img src="https://img.shields.io/badge/Live%20Demo-anifit--livid.vercel.app-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="AniFit live demo">
      </a>
      <br/>
      <img src="https://img.shields.io/badge/Status-🚧%20In%20Development-F9A825?style=flat-square">
      <p>
        A fitness diary with <b>anime gamification</b>. Log your daily activity
        (steps, calories, protein, water, weight & workouts) and discover which
        anime character archetype matches your body composition (FFMI + body fat).
        It projects two futures — the <b>positive route</b> if you keep your habits,
        and the <b>negative route</b> if you drift — to make daily choices feel real.
      </p>
      <p>
    ...
    <td align="center" width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/Status-🚧%20In%20Development-F9A825?style=flat-square">
      <p>
        An app to learn Japanese <b>Hiragana & Katakana</b>. Includes complete
        reference charts (basics, dakuten, handakuten & combinations), random
        recognition quizzes and a <b>Reverse Mode</b> (Romaji → Kana) to practice
        recall. Fully multilingual (🇪🇸 ES / 🇬🇧 EN / 🇯🇵 JA) with route-based i18n.
        Kanji, flashcards and gamification are on the roadmap.
      </p>
      <p>
...
<sub>⚠️ Both projects are actively under development — features and demos may change.</sub>
